      ...
      <header className="relative z-10 bg-black/30 backdrop-blur-md border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            {/* Right Side - App Links & Login */}
            <div className="flex items-center gap-4">
              {/* App Download Links */}
              <div className="hidden lg:flex items-center gap-2 mr-4">
                <span className="text-white/70 text-sm">Get app:</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto mt-16 mb-12">
            ...
            <div className="hidden md:flex bg-white rounded-2xl p-1.5 shadow-2xl items-center">
              {/* Location Section - Shows detected location */}
            ...
            <div className="md:hidden bg-white rounded-2xl p-3 shadow-2xl">
              {/* Location Section */}
              <div className="flex items-center gap-3 px-3 py-2 mb-3 border-b border-gray-200">
                <svg
                  className="w-5 h-5 text-red-500 flex-shrink-0"
                  fill="none"
                  stroke="currentColor"
